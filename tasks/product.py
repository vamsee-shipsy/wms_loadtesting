...
class ProductCreationTaskSet(TaskSet):
    ...
    def create_product(self):
        ...
        self.client.post("/api/v1/core/products/", headers=headers, data=payload)
...
class AsyncProductCreationTaskSet(TaskSet):
    ...
    def create_async_product(self):
        ...
        payload = json.dumps(payload)
        with self.client.post("/api/v1/async/core/products/", headers=self.headers, data=payload) as response:
